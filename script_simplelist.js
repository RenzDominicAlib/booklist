...
//tabbed /////////////////////
		...
		let aboutCntnt = document.querySelector('body > div > div.tabbed > div > div:nth-child(1)');
		let contactBtn = document.querySelector('#tabbed-nav > li:nth-child(2) > button');
		let contactCntnt = document.querySelector('body > div > div.tabbed > div > div.hide');

		aboutBtn.onclick = function(){
			aboutCntnt.classList.remove('hide');
			contactCntnt.classList.add('hide');
		};

		contactBtn.onclick = function(){
			aboutCntnt.classList.add('hide');
			contactCntnt.classList.remove('hide');
		}
